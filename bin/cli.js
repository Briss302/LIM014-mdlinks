...
|__________________HELP_________________|
|=======================================|
| --validate : Valid the status of the  |
|              links                    |
|                                       |
| --stats    : Shows basic statistics   |
|              about links              |
|                                       |
| --stats --validate : Shows valid and  |
|           statistics about this link  |
|                                       |
'---------------------------------------'
    `
)); 
